...
- It is required that the shipping process is organized in what so-called **waves**. A wave is an established by OM time interval and a set of shipping assignments that are to be started and finished during this in interval. Several waves might be organized within one day.
